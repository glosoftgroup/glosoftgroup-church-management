                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="25%">
                                ...
                                <a href="#AddCat"   data-toggle="modal" role="button"  class="right btn btn-primary btn-sm"><i class="icon-plus"></i> Add Category</a>							 
                            </th>
                            <th width="50%">
                                Description
                            </th>
                    ...
                    <table class="table table-striped table-bordered table-hover" >
                        <tbody>
                            <tr>
                                ...
                                <td width="20%">
                                     <?php echo form_input('name[]', $result->name, 'id="name_"  class="form-control name" '); ?>
...
<!-----------------------------EDIT MODAL------------------------->	
<div class="modal fade" id="AddCat" tabindex="-1" data-width="600" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
         <?php
             $attributes = array('class' => 'form-horizontal', 'id' => '');
             echo form_open_multipart('admin/asset_category/quick_add/', $attributes);
         ?>
        <div class="modal-content">
            ...
            <label class=' col-sm-3 control-label' for='name'>Name <span class='required'>*</span></label><div class="col-sm-5">
                <?php echo form_input('name', '', 'id="name"  class="form-control" '); ?><i style="color:red"><?php echo form_error('name'); ?></i>
            </div>
            <div class="clearfix"></div>
            </p>
            <div class="modal-footer">
                <textarea id="description" rows="3"  class="autosize-transition form-control "  name="description" placeholder="Description" /></textarea>
                <div class="clearfix"></div>
                <br>
