<div class="span8">
    <div class="head">
        ...
        <div class="right">                            
            ...
            <?php echo anchor('admin/purchase_order/create/' . $page, '<i class="icon-plus"></i> New Order ', 'class="btn btn-primary"'); ?>
    ...
    <div class="block-fluid">
         ...
         ?>
        <div class='row-form'>
            <div class="span2" for='pay_date'>Payment Date </div>
            <div class="span3">
        ...
        <div class='row-form' style="border:none !important">
            <div class="span2" for='amount'>Amount  </div><div class="span4">
        ...
        <div class='row-form'>
            <div class="span2" for='pay_type'>Payment type <span class='required'>*</span></div>
            <div class="span4">
                 <?php
                     $pays = array(
                             'M-Pesa' => 'M-Pesa',
                     ...
                     echo form_dropdown('pay_type', $pays, (isset($result->pay_type)) ? $result->pay_type : '', ' class="select form-control" data-placeholder="Select  Options..." ');
                 ?>		
                 <?php echo form_error('pay_type'); ?>
            </div>
        </div>

        <div class='row-form'><label class="control-label"></div><div class="span10">
