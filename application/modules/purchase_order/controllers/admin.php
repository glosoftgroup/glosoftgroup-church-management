<?php
    ...
    class Admin extends Admin_Controller
    {
         ...
         function void($id)
         {
              ...
              if ($done)
              {
                   $this->sync->log_update('purchase_order', $id, $form_data);
         ...
         function create($page = NULL)
         {
              ...
              {         //Validation OK!
                   ...
                   $this->sync->log_new('purchase_order', array($ok));
                   ...
                   for ($i = 0; $i < $size; ++$i)
                   {
                        ...
                        $dt = $this->purchase_order_m->insert_purchase($insert_purchase);
                        $this->sync->log_new('purchase_order_list', array($dt));
                   }
         ...
         function make_pay($id = FALSE, $page = NULL)
         {
              ...
              {         //Validation OK!
                   ...
                   $form_data = array(
                           'date' => strtotime($this->input->post('pay_date')),
                           'amount' => $amount,
                           'order_id' => $id,
                   ...
                   if ($ok)
                   {
                        $this->sync->log_new('purchase_order_payment', array($ok));
                        /*                         * **
         ...
         function delete($id = NULL, $page = 1)
         {
              ...
              {
                   $this->sync->log_delete('purchase_order', $id);
