<div class="col-sm-12">
    <div class="panel panel-default animated fadeIn"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?php echo ($updType == 'edit') ? 'Edit ' : 'Add '; ?> Other Revenues </h3>

            <div class="heading-elements">
                <div class="btn-group">
                     <?php echo anchor('admin/other_revenues/create', '<i class="icon-plus-sign-alt"></i> <span> ' . lang('web_add_t', array(':name' => 'Other Revenues')) . '</span>', 'class="btn btn-primary"'); ?> 
        ...
        <div class="panel-body" style="display: block;">    
            ...
            <div class='form-group'>
                <label class='col-sm-3 control-label' for='project'>Project <span class='required'>*</span></label>
                <div class="col-sm-5">
                     <?php
            ...
            <div class='form-group'>
                <label class=' col-sm-3 control-label' for='amount'>Amount <span class='required'>*</span></label><div class="col-sm-5">
            ...
            <div class='form-group'>
                ...
                <div class="col-sm-5">
                     <?php
                         echo form_dropdown('collected_by', $users, (isset($result->collected_by)) ? $result->collected_by : '', ' id="form-field-select-1" class="form-control search-select" data-placeholder="Select Options..." ');
                     ?> <i style="color:red"><?php echo form_error('collected_by'); ?></i>
                </div></div>

            <div class='form-group'>
                <label class='col-sm-3 control-label' for='bank'>Bank </label>
                <div class="col-sm-5">
                     <?php
            ...
            <div class='form-group'><label class="col-sm-3 control-label"></label><div class="col-sm-5">
                    ...
                    <?php echo anchor('admin/other_revenues', 'Cancel', 'class="btn btn-light-grey"'); ?>
                </div></div>
