<?php
	...
	modified_on INT(11) 
         ...
         function get_list($iDisplayStart, $iDisplayLength, $iSortCol_0, $iSortingCols, $sSearch, $sEcho)
         {
              ...
              // Total data set length
              $iTotal = $this->db//->where('permissions.campus_id', $this->campus->id)
          ...
          * @return type
          */
         function fetch_route_old($id)
         {
              $cc = $this->db->where(array('id' => $id))->get('routes')->row();
              return $cc ? $cc : FALSE;
         }
         ...
         {
              return $this->db->where('is_menu', 1)->get('routes')->result();
         }
