                         ...
                         foreach ($groups as $gid => $title)
                         {
                             ...
                             <li>
                                 <a class="permaget" href="javascript:void(0)" data-rec="<?php echo $gid; ?>">
                                     <span class="desc"> <?php echo $i . '. ' . ucwords($title); ?></span>
                                     <span class="label label-info"><?php //echo $cc->size;          ?> Users</span>
                                 </a>
                             </li>
                        <?php } ?> 
                </ul>   
...
<!-- -->
<div class="modal fade in" style="display: none;" id="edmodal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="spinn" style="display: none;" ><img src="<?php echo base_url('assets/ico/loader.gif'); ?>"/></div>
