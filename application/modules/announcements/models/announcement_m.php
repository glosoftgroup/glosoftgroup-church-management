<?php
    ...
    class Announcement_m extends MY_Model
    {
         ...
         function find($id)
         {
              return $this->db->where(array('id' => $id))->get('announcements')->row();
         }

         function exists($id)
         {
              return $this->db->where(array('id' => $id))->count_all_results('announcements') > 0;
         }
         ...
         {
              return $this->db->where('id', $id)->update('announcements', $data);
         }
	...
	modified_on INT(11) 
         ...
         function paginate_all($limit, $page)
         {
              ...
              $query = $this->db->get('announcements', $limit, $offset);
