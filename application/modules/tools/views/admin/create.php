...
<div class="widget-block col-md-6">
    ...
    <div class="widget-content">
        <div class="widget-box">
            ...
            <textarea   name="scaffold_code"  class='code_area' /><?php echo set_value('scaffold_code', ''); ?></textarea>
            ...
            <label>
                ...
                <label>
                    <input type='checkbox'  name='scaffold_routes' id='scaffold_routes' value='<?php echo set_value('scaffold_routes', '1'); ?>' /> 
                    <span class="lbl">  </span> <label class='labelforminline' for="scaffold_routes"><?php echo lang('scaffolds_modify_routes') ?></label><br/>
                </label>
                <label>
                    <input type='checkbox' name='scaffold_menu' id='scaffold_menu' value='<?php echo set_value('scaffold_menu', '1'); ?>' /> 
