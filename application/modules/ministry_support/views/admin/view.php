    ...
    <div class="panel panel-default"> 
        ...
        <div class="panel-body" style="display: block;">   
            <div class="widget-main">
                ...
                <div class="col-sm-7">
                     <?php if ($members_ministry_support): ?>
                             ...
                             <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                 ...
                                 <tbody>
                                      ...
                                      foreach ($members_ministry_support as $p):
                                           $i++;
                                           if ($i == 6)
                                                break;
                                           ?>
                                              ...
                                              <td width=''>
                                                  <div>
                                                      <div class='btn-group'>
                                                          ...
                                                          <a class='btn btn-danger btn-sm' onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('admin/ministry_support/void/' . $p->id . '/' . $page); ?>'>
                ...
                <div class="col-sm-5">                     
                     <?php if ($ministry_support): ?>
                             ...
                             <h3>List of Ministry Support</h3>
                             <hr />
                             <div class='clearfix'></div>
         ...
         <div class="modal fade" id="Receipt<?php echo $p->id; ?>" tabindex="-1" data-width="1000" role="dialog" aria-hidden="true">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                      <?php
                      $post = $this->ministry_support_m->get_member_giving($p->id);
                     ...
                     <div class=" receipt"> 
                         ...
                         <div class="col-sm-12">
                             ...
                             Being given as <abbr  > Ministry Support</abbr >
