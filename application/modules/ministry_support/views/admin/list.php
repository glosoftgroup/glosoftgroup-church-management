<div class="col-sm-12">
    <div class="panel panel-default animated fadeIn"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">All Ministry Support </h3>
            ...
            <div class="heading-elements">
                <div class="btn-group">
                     ...
                     <?php echo anchor('admin/ministry_support', '<i class="icon-list"></i> <span>' . lang('web_list_all', array(':name' => 'Ministry Support')) . '</span>', 'class="btn btn-info"'); ?> 
            ...
            <div class="col-sm-12">
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        ...
                        Today's Ministry Support <span class="badge badge-info">KES <?php echo number_format($todays, 2); ?></span>
                    </button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        <i class="clip-pie"></i><br>
                        This Month's Ministry Support <span class="badge badge-info">KES <?php echo number_format($months, 2); ?></span>
                    </button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        <i class="clip-folder"></i><br>
                        This Year's Ministry Support <span class="badge badge-info">KES <?php echo number_format($years, 2); ?></span>
                    </button>
                </div>
            </div>	
                             ...
                             <tbody>
                                  ...
                                  foreach ($ministry_support as $p):
                                      ...
                                      <tr>
                                          ...
                                          <td><?php echo $i . '.'; ?></td>					
                                          <td><a class="tooltips" data-original-title="View Details" data-placement="top" href='<?php echo site_url('admin/ministry_support/view_members/' . $p->id . '/' . $page); ?>'><i class="icon-double-angle-right"></i> <?php echo date('d M Y', $p->date); ?></a></td>
                                          ...
                                          <td width=''>
                                              ...
                                              <div>
                                                  <div class='btn-group'>
                                                      ...
                                                      <a class='btn btn-success btn-sm' href='<?php echo site_url('admin/ministry_support/view_members/' . $p->id . '/' . $page); ?>'>
                                  ...
                                  <div class="modal fade" id="Edit_<?php echo $p->id; ?>" tabindex="-1" data-width="600" role="dialog" aria-hidden="true">
                                      ...
                                      echo form_open_multipart('admin/ministry_support/edit/' . $p->id . '/1', $attributes);
                                      ?>
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                              ...
                                              <h4 class="modal-title">Edit Ministry Support Details</h4>
                                              <div class="clearfix"></div>
                                          </div>
                                          <p>
                                          <div class="clearfix"></div>
