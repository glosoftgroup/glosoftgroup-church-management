<?php
    ...
    class Ss_parents_m extends MY_Model
    {
         ...
         function find($id)
         {
              return $this->db->where(array('id' => $id))->get('ss_parents')->row();
         }

         function exists($id)
         {
              return $this->db->where(array('id' => $id))->count_all_results('ss_parents') > 0;
         }

         function count()
         {

              return $this->db->count_all_results('ss_parents');
         }

         function update_attributes($id, $data)
         {
              return $this->db->where('id', $id)->update('ss_parents', $data);
         }
         ...
         function delete($id)
         {
              return $this->db->delete('ss_parents', array('id' => $id));
         }
	...
	modified_on INT(11) 
         ...
         function paginate_all($limit, $page)
         {
              ...
              $query = $this->db->get('ss_parents', $limit, $offset);
