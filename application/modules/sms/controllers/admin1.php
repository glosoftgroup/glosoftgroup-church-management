<?php
    ...
    class Admin extends Admin_Controller
    {
         ...
         function test()
         {
              $recipient = '0775077768';
              $message = 'Hello Martin, Thanks for Choosing FPM';
