    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-7">
                <p id="rc_staff" >
                     <?php
                         echo form_dropdown('staff', array('' => 'Select Staff') + $staff, ' class="form-control search-select"  ');
                ...
                <p id="rc_member" >
                     <?php
                         echo form_dropdown('member', array('' => 'Select Member') + (array) $mms, ' class="form-control search-select" ');
                ...
                <p id="rc_ministry" >
                     <?php
                         echo form_dropdown('ministry', array('' => 'Select Ministry') + (array) $mins, ' class="form-control search-select" ');
                         echo form_error('ministry');
                     ?>
                </p>
                <p id="rc_hbcs" >
                     <?php
                         echo form_dropdown('hbc', array('' => 'Select HBC') + (array) $hbs, ' class="form-control search-select" ');
                         echo form_error('hbc');
                     ?>
                </p>
                <p id="rc_multiple" >
                     <?php
                         echo form_dropdown('members[]', $mms, 'multiple="multiple" class="form-control search-select" placeholder="Select Member"');
...
<?php if ($this->uri->segment(3) == 'compose')
    {
         ?>
              show_field('None');
    <?php } ?>
