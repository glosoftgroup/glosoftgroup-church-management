                             ...
                             <tbody>
                                      ...
                                      <tr>
                                          ...
                                          <td width='150'>
                                              <div class='btn-group'>
                                                  ...
                                                  <a class="btn btn-danger btn-sm" onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('admin/deductions/delete/' . $p->id . '/' . $page); ?>'><i class='icon-trash'></i> Remove</a>
                                  ...
                                  <div class="modal fade" id="Edit_<?php echo $p->id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                      <div class="modal-dialog">
                                           ...
                                           echo form_open_multipart('admin/deductions/edit/' . $p->id . '/1', $attributes);
                                           ?>
                                          <div class="modal-content">
                                              ...
                                              <div id="entry1" class="clonedInput">
                                                  <label class='col-sm-3 control-label' for='name'>Deduction Type</label><div class="col-sm-8 input-group">
