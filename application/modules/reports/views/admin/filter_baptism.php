    ...
    <div class="panel panel-default animated fadeIn"> 
        ...
        <div class="panel-body" style="display: block;">   
            <div class="widget-main">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <br>
                            <h1 class="panel-title">All Baptisms Visitors <abbr  ><?php echo number_format($count_baptism); ?> </abbr  > </h1>
                            </br>
                        ...
                        <div class="col-md-6 filter-panel">
                             <?php
                                 ...
                                 echo form_open_multipart('admin/reports/baptism_byDate/', $attributes);
                             ?>
                                         ...
                                         <table class="table table-condensed table-hover" id="">
                                             ...
                                             <tbody>
                                                  ...
                                                  foreach ($members as $p)
                                                  {
                                                       ...
                                                       $members = $this->ion_auth->get_members();
                                                       $ss = $this->ion_auth->get_ss_school();
                                                       $i++;
                                                       ?>
                                                      <tr>
                                                          <td><?php echo $i . '.'; ?></td>	
         ...
         <?php } ?>
                                    ...
                                    {
                                         ?>
                                         <h3 class="panel-title"> No Baptism recorded at the moment !!</h3>
    <?php } ?>
