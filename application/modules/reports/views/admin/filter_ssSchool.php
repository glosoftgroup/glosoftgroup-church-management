<div class="col-sm-12">
    <div class="panel panel-default"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">Reports Of <?php 'Sunday School  - (' . date('Y') . ')'; ?> </h3>
            ...
            <div class="widget-main">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <br>
                            <h1 class="panel-title">All Registered Sunday School <abbr  ><?php echo number_format($count_sSchool); ?> </abbr  > </h1>
                            </br>
                        ...
                        <div class="col-md-6 filter-panel">
                             <?php
                                 ...
                                 echo form_open_multipart('admin/reports/ssSchool_byDate/', $attributes);
                             ?>
