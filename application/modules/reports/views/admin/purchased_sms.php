<div class="col-sm-12">
    <div class="panel panel-default"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">Reports Of <?php echo 'Purchased SMS  - (' . date('Y') . ')'; ?> </h3>
        ...
        <div class="panel-body" style="display: block;">   
            <div class="widget-main">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <br>
                            <h1 class="panel-title">All Purchased SMS <abbr  ><?php echo number_format($count_purchased_sms->total); ?> </abbr  > </h1>
                            </br>
                        ...
                        <div class="col-md-7 filter-panel">
                             <?php
                                 ...
                                 echo form_open_multipart('admin/reports/purchased_byDate/', $attributes);
                             ?>
                                         ...
                                         <table class="table table-condensed table-hover" id="">
                                             ...
                                             <tbody>
                                                  ...
                                                  foreach ($sms as $p)
                                                  {
                                                       ...
                                                       $m = $this->ion_auth->get_user($p->created_by);
         ...
         <?php } ?>
                                         ...
                                         <div class="pull-right" id="months"  <?php echo preg_match('/^(admin\/reports\/purchased_byDate)$/i', $this->uri->uri_string()) ? 'style="display:block !important;" ' : ''; ?>>
