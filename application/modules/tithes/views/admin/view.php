<div class="col-sm-12 main-rec">
    <div class="panel panel-default animated fadeIn"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">Tithes Per Member </h3>
            ...
            <div class="heading-elements">
                <div class="btn-group">
                    ...
                    <?php echo anchor('admin/tithes', '<i class="icon-list"></i> <span>' . lang('web_list_all', array(':name' => 'Tithes')) . '</span>', 'class="btn btn-info"'); ?> 
        ...
        <div class="panel-body" style="display: block;">   
            <div class="widget-main">
                ...
                <div class="col-sm-7">
                     <?php if ($members_tithe): ?>

                             <h3 class="cc-title">Collection Date  <span style="color:blue; text-decoration:underline"><?php echo date('d M Y', $post->date); ?></span></h3>
                             <hr />

                             <div class='clearfix'></div>
                             <table class="table table-striped table-bordered table-hover table-full-width sample-right" id="sample_2">
                                 ...
                                 <tbody>
                                      ...
                                      foreach ($members_tithe as $p):
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                   <?php if (is_numeric($p->member_id))
                                                   {
                                                        ?>
                                                       <a href='<?php echo site_url('admin/members/profile/' . $p->member_id); ?>'><?php echo $members[$p->member_id]; ?></a>
                                                  <?php
                                                  }
                                                  else
                                                  {
                                                       ?>
                   <?php echo $p->member_id; ?>
              <?php } ?>
                                              ...
                                              <td width=''>
                                                  <div>
                                                      <div class='btn-group'>
                                                          ...
                                                          <a class='btn btn-danger btn-sm' onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('admin/tithes/void/' . $p->id . '/' . $page); ?>'>
...
<?php endif ?>
                ...
                <div class="col-sm-5 sample-left">                     
<?php if ($tithes): ?>

                             <h3>List of tithes</h3>
                             <hr />
                             <div class='clearfix'></div>
                                              ...
                                              <td width=''>
                                                  <div>
                                                      <div class='btn-group'>
                                                          ...
                                                          <a class='btn btn-success btn-sm' href='<?php echo site_url('admin/tithes/view_members/' . $p->id . '/' . $page); ?>'>
...
<?php
    foreach ($members_tithe as $p):
         ...
         <div class="modal fade" id="Receipt<?php echo $p->id; ?>" tabindex="-1" data-width="1000" role="dialog" aria-hidden="true">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                      <?php
                      $post = $this->tithes_m->get_member_giving($p->id);
         ...
         ?>
                         ...
                         <div class="col-sm-12">
                             Received From <abbr >
                                  ...
                                  {
                                       ?>
                                       <?php echo $member->title . ' ' . $member->first_name . ' ' . $member->last_name . ' [ Code: ' . $member->member_code . ' ]'; ?>
                                  <?php
                                  }
                                  else
                                  {
         ...
         <?php } ?>
                             ...
                             </abbr> The Amount of KES <abbr  ><?php echo number_format($post->amount, 2) ?></abbr > 
                             Being given as <abbr  >Tithe contribution</abbr >
