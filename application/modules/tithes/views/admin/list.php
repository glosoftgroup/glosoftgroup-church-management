<div class="col-sm-12">
    <div class="panel panel-default animated fadeIn"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">All Tithes </h3>
            ...
            <div class="col-sm-12">
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        ...
                        Today's Tithes <span class="badge badge-info">KES <?php echo number_format($todays, 2); ?></span>
                    </button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        <i class="clip-pie"></i><br>
                        This Month's Tithes <span class="badge badge-info">KES <?php echo number_format($months, 2); ?></span>
                    </button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        <i class="clip-folder"></i><br>
                        This Year's Tithes <span class="badge badge-info">KES <?php echo number_format($years, 2); ?></span>
                    </button>
                </div>
            </div>			   
                             ...
                             <tbody>
                                  ...
                                  foreach ($tithes as $p):
                                      ...
                                      <tr>
                                          ...
                                          <td><a class="tooltips" data-original-title="View Details" data-placement="top" href='<?php echo site_url('admin/tithes/view_members/' . $p->id . '/' . $page); ?>'><i class="icon-double-angle-right"></i><?php echo number_format($p->totals, 2); ?></a></td>
                                  ...
                                  <div class="modal fade" id="Edit_<?php echo $p->id; ?>" tabindex="-1" data-width="600" role="dialog" aria-hidden="true">
                                      ...
                                      echo form_open_multipart('admin/tithes/edit/' . $p->id . '/1', $attributes);
                                      ?>
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                          ...
                                          <div id="entry1" class="clonedInput">
                                              ...
                                              <div class="col-sm-8 input-group">
                                                  ...
                                                  <?php
                                                  echo form_input('totals', $p->totals, 'id="totals" disabled class="form-control" ');
