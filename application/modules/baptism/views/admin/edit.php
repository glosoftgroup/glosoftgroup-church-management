            ...
            <?php if ($result->type == 2)
                {
                     ...
                     <div class='form-group'>
                         ...
                         <div class="col-sm-5">
                              <?php
                             echo form_dropdown('member', array('' => 'Select Child') + $ss, (isset($result->member)) ? $result->member : '', ' id="form-field-select-1" class="form-control search-select" data-placeholder="Select Options..." ');
