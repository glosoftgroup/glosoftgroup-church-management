...
<div class="col-sm-12">
    <div class="panel panel-default animated fadeIn"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?php echo ($updType == 'edit') ? 'Edit ' : 'Add '; ?> Thanks Giving </h3>
        ...
        <div class="panel-body" style="display: block;">    
            ...
            <div class='col-sm-6'>
                <h3>Members Giving Thanks Giving</h3>
            ...
            <div class='form-group'><label class="col-sm-3 control-label"></label><div class="col-sm-8">
                    ...
                    <?php echo anchor('admin/thanks_giving', 'Cancel', 'class="btn btn-light-grey"'); ?>
                </div>
            </div>
        </div>
    </div> 
