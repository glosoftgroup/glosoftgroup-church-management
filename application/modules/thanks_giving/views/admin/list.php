<div class="col-sm-12">
    <div class="panel panel-default"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">All Thanks Giving </h3>

            <div class="heading-elements">
                <div class="btn-group">
                     <?php echo anchor('admin/thanks_giving/create', '<i class="icon-plus-sign-alt"></i> <span> ' . lang('web_add_t', array(':name' => 'Thanks Giving')) . '</span>', 'class="btn btn-primary"'); ?> 
                     <?php echo anchor('admin/thanks_giving', '<i class="icon-list"></i> <span>' . lang('web_list_all', array(':name' => 'Thanks Giving')) . '</span>', 'class="btn btn-info"'); ?> 
                     <?php echo anchor('admin/thanks_giving/voided', '<i class="icon-list-alt"></i> <span> Voided Thanks Giving</span>', 'class="btn btn-warning"'); ?> 
                </div>
            </div>
        </div>             
            ...
            <div class="col-sm-12">
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        ...
                        Today's Thanks Giving <span class="badge badge-info">KES <?php echo number_format($todays, 2); ?></span>
                    </button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        <i class="clip-pie"></i><br>
                        This Month's Thanks Giving <span class="badge badge-info">KES <?php echo number_format($months, 2); ?></span>
                    </button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-icon btn-block">
                        <i class="clip-folder"></i><br>
                        This Year's Thanks Giving <span class="badge badge-info">KES <?php echo number_format($years, 2); ?></span>
                    </button>
                </div>
            </div>	
                             ...
                             <tbody>
                                  ...
                                  foreach ($thanks_giving as $p):
                                      ...
                                      <tr>
                                          ...
                                          <td><a class="tooltips" data-original-title="View Details" data-placement="top" href='<?php echo site_url('admin/thanks_giving/view_members/' . $p->id . '/' . $page); ?>'><i class="icon-double-angle-right"></i><?php echo number_format($p->totals, 2); ?></a></td>
                                          ...
                                          <td width=''>
                                              ...
                                              <div>
                                                  <div class='btn-group'>
                                                      ...
                                                      <a class='btn btn-success btn-sm' href='<?php echo site_url('admin/thanks_giving/view_members/' . $p->id . '/' . $page); ?>'>
                                  ...
                                  <div class="modal fade" id="Edit_<?php echo $p->id; ?>" tabindex="-1" data-width="600" role="dialog" aria-hidden="true">
                                      ...
                                      echo form_open_multipart('admin/thanks_giving/edit/' . $p->id . '/1', $attributes);
                                      ?>
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                              ...
                                              <h4 class="modal-title">Edit Thanks Giving Details </h4>
                                              <div class="clearfix"></div>
                                          </div>
                                          <p>
                                          <div class="clearfix"></div>
