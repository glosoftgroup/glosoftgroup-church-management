<div class="col-sm-12 main-rec">
    <div class="panel panel-default"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">Thanks Giving Per Member </h3>
                     ...
                     <?php if ($members_thanks_giving): ?>
                             ...
                             <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                 ...
                                 <tbody>
                                      ...
                                      foreach ($members_thanks_giving as $p):
                                           $i++;
                                           if ($i == 6)
                                                break;
                                           ?>
                                              ...
                                              <td >
                                                  <div>
                                                      <div class='btn-group'>
                                                          ...
                                                          <a class='btn btn-danger btn-sm' onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('admin/thanks_giving/void/' . $p->id . '/' . $page); ?>'>
                                                              <i class='icon-share'></i> Void Giving
                                                          </a>
                                                      </div>
                                                  </div>
                                              </td>
         ...
         <div class="modal fade" id="Receipt<?php echo $p->id; ?>" tabindex="-1" data-width="1000" role="dialog" aria-hidden="true">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                      <?php
                      $post = $this->thanks_giving_m->get_member_giving($p->id);
