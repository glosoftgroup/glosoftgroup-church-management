...
<!-- Wizard with validation -->
                    <div class="panel panel-white">
                        <div class="panel-heading">
                         ...
                         <?php $attributes = array('class' => 'stepy-validation', 'id' => 'form');
                         ...
                         ?>
                            <fieldset title="1">
                                    ...
                                    <div class="col-md-6">
                                        <div class='form-group'>
                                            ...
                                            <div class="col-sm-8 input-group">
                                                ...
                                                <input id='date_joined_' type='text' name='date_joined' required='required' class='form-control date-picker' value="<?php echo set_value('date_joined', (isset($result->date_joined)) ? $result->date_joined : ''); ?>"  />
                                  ...
                                  <div class='row'>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class="col-sm-8 input-group">
                                            ...
                                            <input id='dob_' type='text' name='dob' required='required' class='form-control date-picker' value="<?php echo set_value('dob', (isset($result->dob)) ? $result->dob : ''); ?>"  />
                                ...
                                <div class='row'>
                                   <div class='col-md-6'>
                                        <div class='form-group'>
                                            <label class=' col-sm-3 control-label' for='last_name'>ID Number </label><div class="col-sm-8 input-group">
                                                <span class="input-group-addon"> <i class="icon-user"></i> </span>
                                   ...
                                   <div class='col-md-6'>
                                    <div class='form-group'>
                                        <label class=' col-sm-3 control-label' for='location'>Location | Estate <span class='required'>*</span></label><div class="col-sm-8 input-group">
                                            ...
                                            <?php echo form_input('location', $result->location, 'id="location_" required="required" class="form-control" '); ?>
                     ...
                     <div class='col-md-6'>
                        <div class='form-group'>
                            ...
                            <fieldset title="2">
                                ...
                                <div class='row'>
                                  <div class='col-md-6'>
                                   ...
                                   <div class='col-md-6'>
                                    <h2 class="StepTitle">Education & Occupation Details</h2>
                                    <div class='form-group'>
                                        <label class=' col-sm-3 control-label' for='last_name'>Education Level </label><div class="col-sm-5 input-group">
                                            <span class="input-group-addon"> <i class="icon-book"></i> </span>
                                            <?php echo form_input('education_level', $result->education_level, 'id="education_level"  class="form-control" '); ?>
                                            <i style="color:red"><?php echo form_error('education_level'); ?></i>
                                        </div>
                                    </div>
                                  </div>
                                  </div>
                                  ...
                                  <div class='row'>
                                      ...
                                      <div class='col-md-6'>
                                        <div class='form-group'>
                                            <label class=' col-sm-3 control-label' for='employer'>Employer </label><div class="col-sm-5 input-group">
                                                <span class="input-group-addon"> <i class="icon-user"></i> </span>
                            ...
                            <fieldset title="3">
                                <legend class="text-semibold">Next of Kin Details</legend>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class='form-group'>
                                ...
                                <div class="row">
                                    ...
                                    <div class='form-group'>
                                        <label class=' col-sm-3 control-label' for='location'> Residential </label><div class="col-sm-8 input-group">
                                            <span class="input-group-addon"> <i class="clip-location"></i> </span>
                                            <?php echo form_input('location1', $result->location1, 'id="location1_"  class="form-control" '); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class='form-group'>
                                            <label class=' col-sm-3 control-label' for='additionals'>Additional Info </label><div class="col-sm-8">
                                                <textarea id="additionals"  class="autosize-transition  form-control "  name="additionals1"  /><?php echo set_value('additionals', (isset($result->additionals)) ? htmlspecialchars_decode($result->additionals) : ''); ?></textarea>
                            ...
                            <fieldset title="4">
                                <legend class="text-semibold"> Ministries | Home Based Church</legend>
