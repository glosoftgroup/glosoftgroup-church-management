    ...
    class Admin extends Admin_Controller
    {
         ...
         function create($page = NULL)
         {
              ...
              {         //Validation OK!
                   ...
                   {
                        $this->sync->log_new('accounts', array($ok));
         ...
         function edit($id = FALSE, $page = 0)
         {
              ...
              if ($this->form_validation->run())  //validation has been passed
              {
                   ...
                   if ($done)
                   {
                        $this->sync->log_update('accounts', $id, $form_data);
         ...
         function delete_old($id = NULL, $page = 1)
         {
              //filter & Sanitize $id
              $id = ($id != 0) ? filter_var($id, FILTER_VALIDATE_INT) : NULL;
              ...
              //delete the item
              if ($this->accounts_m->delete($id) == TRUE)
              {
                   $this->sync->log_delete('accounts', $id);
