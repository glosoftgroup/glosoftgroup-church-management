<div class="col-sm-12 main-rec">
    <div class="panel panel-default"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title">Seed Planting Per Member </h3>
                     ...
                     <?php if ($members_seed_planting): ?>
                             ...
                             <table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                 ...
                                 <tbody>
                                      ...
                                      $i = 0;
                                      $totals = 0;
                                      foreach ($members_seed_planting as $p):
                                           $i++;
                                              ...
                                              <td width=''>
                                                  <div>
                                                      <div class='btn-group'>
                                                          ...
                                                          <a class='btn btn-danger btn-sm' onClick="return confirm('<?php echo lang('web_confirm_delete') ?>')" href='<?php echo site_url('admin/seed_planting/void/' . $p->id . '/' . $page); ?>'>
         ...
         <div class="modal fade" id="Receipt<?php echo $p->id; ?>" tabindex="-1" data-width="1000" role="dialog" aria-hidden="true">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                      <?php
                      $post = $this->seed_planting_m->get_member_giving($p->id);
                     ...
                     <div class=" receipt"> 
                         ...
                         <div class="col-sm-12">
                             ...
                             Being given as <abbr  > Seed Planting</abbr >
