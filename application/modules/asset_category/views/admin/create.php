<div class="col-sm-12">
    <div class="panel panel-default"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?php echo ($updType == 'edit') ? 'Edit ' : 'Add '; ?> Asset Category </h3>
        ...
        <div class="panel-body" style="display: block;">    
            ...
            ?>
            <div class='col-sm-12'>
                <h3>Add Multiple Asset Category</h3>
                    ...
                    <table class="table table-striped table-bordered table-hover" >
                        <tbody>
                            <tr>
                                ...
                                <td width="50%">
                                    <textarea id="description"  class="autosize-transition ckeditor11 form-control description" id="desc" name="description[]"  /><?php echo set_value('description', (isset($result->description)) ? htmlspecialchars_decode($result->description) : ''); ?></textarea>
...
<?php echo anchor('admin/asset_category', 'Cancel', 'class="btn btn-light-grey"'); ?>
                </div></div>
