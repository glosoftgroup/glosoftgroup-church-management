...
<div class="col-sm-12">
    <div class="panel panel-default animated fadeIn"> 
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?php echo ($updType == 'edit') ? 'Edit ' : 'Add '; ?> Donations </h3>

            <div class="heading-elements">
                <div class="btn-group">
                     <?php echo anchor('admin/donations/create', '<i class="icon-plus-sign-alt"></i> <span> ' . lang('web_add_t', array(':name' => 'Donations')) . '</span>', 'class="btn btn-primary"'); ?> 
        ...
        <div class="panel-body" style="display: block;">    
            ...
            <div class="col-sm-6">
                ...
                <div class='form-group'>
                    ...
                    <div class="col-sm-8 input-group">
                        ...
                        <?php echo form_input('donor', $result->donor, 'id="donor_"  class="form-control" '); ?>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-sm-8">
                         <?php
                             echo form_dropdown('country', $countrylist, (isset($result->country)) ? $result->country : '', ' id="form-field-select-1" class="form-control search-select" data-placeholder="Select Options..." ');
            ...
            <div class="col-sm-6">	
                <div class='form-group'>
                    <label class=' col-sm-3 control-label' for='donation_type'>Donation Type <span class='required'>*</span></label><div class="col-sm-8">
                         <?php
                ...
                <div class='form-group'>
                    <label class=' col-sm-3 control-label' for='pledged_amount'>Pledged Amount <span class='required'>*</span></label><div class="col-sm-8 input-group">
                        <span class="input-group-addon"> <i class="icon-money"></i> </span>
                        <?php echo form_input('pledged_amount', $result->pledged_amount, 'id="pledged_amount_"  class="form-control" '); ?>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-sm-8 input-group">
                        ...
                        <?php echo form_input('value', $result->value, 'id="value_"  class="form-control" placeholder="If Merchandise or Service offered" '); ?>
            ...
            <div class='form-group'><label class="col-sm-3 control-label"></label><div class="col-sm-8">
                    ...
                    <?php echo anchor('admin/donations', 'Cancel', 'class="btn btn-light-grey"'); ?>
                </div></div>
