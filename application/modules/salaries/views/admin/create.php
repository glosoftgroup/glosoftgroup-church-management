        ...
        <div class="panel-body" style="display: block;">    
            ...
            <div class='form-group'>
                ...
                <div class="col-sm-5">
                    ...
                    <?php echo form_dropdown('deductions[]', $deductions, '', ' multiple="multiple" class="form-control search-select select2-offscreen "'); ?>
                </div>
            </div> 
            <div class='form-group'>
                ...
                <div class="col-sm-5">
                    ...
                    <?php echo form_dropdown('allowances[]', $allowances, '', ' multiple="multiple" class="form-control search-select select2-offscreen "'); ?>
                </div>
            </div> 
