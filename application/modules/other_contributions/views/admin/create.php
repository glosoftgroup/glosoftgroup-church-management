        ...
        <div class="panel-body" style="display: block;">    
            <div class='col-sm-6'>           
                ...
                <div class='form-group'>
                    <label class='col-sm-3 control-label' for='contribution_type'>Contributions Type</label>
                    <div class="col-sm-8 input-group">
                         <?php
                             echo form_dropdown('contribution_type', $contributions, (isset($result->contribution_type)) ? $result->contribution_type : '', ' id="form-field-select-1" class="form-control search-select" data-placeholder="Select Options..." ');
                         ?> 
                        <span data-toggle="modal"  role="button" href="#myModal2" class="input-group-addon btn btn-info btn-squared"> <i class="icon-plus"></i> Add Type </span>
                        <i style="color:red"><?php echo form_error('contribution_type'); ?></i>
                    </div></div>
                <div class='form-group'>
            ...
            <div class='col-sm-6'>
                ...
                <div class="btn-group">
                    <a id="btnAdd" class="btn btn-success btn-sm clone">Add New Line</a> 
                    <a  id="btnDel" class="btn btn-danger btn-sm remove">Remove</a>
                </div> 
            </div>
            <div class="clearfix"></div>
            <hr /> 
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form action="<?php echo site_url('admin/contribution_types/quick_add'); ?>" class='form-horizontal' method="POST" >
