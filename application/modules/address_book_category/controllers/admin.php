    ...
    class Admin extends Admin_Controller
    {
         ...
         function create($page = NULL)
         {
              ...
              {         //Validation OK!
                   ...
                   {
                        $this->sync->log_new('address_book_category', array($ok));
                        $this->session->set_flashdata('message', array('type' => 'success', 'text' => 'Address Book Category ' . lang('web_create_success')));
                   }
                   else
                   {
                        $this->session->set_flashdata('error', array('type' => 'error', 'text' => 'Address Book Category ' . lang('web_create_failed')));
                   }
         ...
         function edit($id = FALSE, $page = 0)
         {
              ...
              if ($this->form_validation->run())  //validation has been passed
              {
                   ...
                   if ($done)
                   {
                        $this->sync->log_update('address_book_category', $id, $form_data);
                        $this->session->set_flashdata('message', array('type' => 'success', 'text' => 'Address Book Category ' . lang('web_edit_success')));
                        redirect("admin/address_book_category/");
                   }
                   else
                   {
         ...
         function delete($id = NULL, $page = 1)
         {
              ...
              {
                   $this->sync->log_delete('address_book_category', $id);
                   $this->session->set_flashdata('message', array('type' => 'sucess', 'text' => 'Address Book Category ' . lang('web_delete_success')));
              }
              else
              {
