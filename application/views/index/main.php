                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-8 col-xs-12 main-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7 col-sm-7 col-xs-12">
                                            ...
                                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;admin is a fully responsive Magento theme with advanced admin module. Based on Bootstrap’s 12 column 1200px responsive grid Theme. Great looks on desktops, tablets and mobiles. <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;admin is extremely customizable, easy to use and fully responsive. Suitable for every type of store. Great as a starting point for your custom projects. This theme includes several extensions including ajax price slider that will help you improve your sales. We supply a full help with our products and after purchase support to all our customers. <a href="#">Buy admin Theme!</a></p>
                                        </div><!-- End .col-md-7 -->
                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                            <div class="sm-margin visible-xs"></div><!-- space -->
                                            <img src="images/showcase.png" alt="Showcase admin" class="img-responsive">
                                        </div><!-- End .col-md-5 -->
                                    </div><!-- End .row -->
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-12 sidebar">
                                    <div class="widget subscribe">
                                        ...
                                        <p> Get all the latest information on Events, Sales and Offers. Sign up for the admin store newsletter today.</p>
