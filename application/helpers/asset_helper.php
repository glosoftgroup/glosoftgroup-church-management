...
function mysql_date($str){
	if(empty($str)||$str=='0000-00-00') return '0000-00-00';
	$date = new DateTime($str);
...
function core_js($asset_name)
{      
  return "<script src='".plugin_path($asset_name)."' type='text/javascript'></script>";
}
    
function core_css($asset_name)
{
  return "<link href='".plugin_path($asset_name)."' rel='stylesheet' type='text/css' />"; 
}