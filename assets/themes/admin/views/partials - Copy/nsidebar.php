<div class="main-navigation navbar-collapse collapse">
    ...
    <ul class="main-navigation-menu">
        ...
        <?php
        if (($this->acl->is_allowed(array('members'), 1) ) ||
                     ($this->acl->is_allowed(array('sunday_school'), 1) ) ||
                     ($this->acl->is_allowed(array('visitors'), 1) ) ||
                     ($this->acl->is_allowed(array('dedications'), 1) ) ||
                     ($this->acl->is_allowed(array('baptism'), 1) )
        )
        {
                ?>
                <li <?php echo in_array($this->uri->segment(2), $set) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('sunday_school'), 1))
                        {
                                ?>
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('visitors'), 1))
                        {
                                ?>
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('dedications'), 1))
                        {
                                ?>
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('baptism'), 1))
                        {
        ...
        foreach ($set as $ws)
        {
                if ($this->acl->is_allowed(array($ws), 1))
                {
                        $kval = TRUE;
                        break;
                }
        ...
        if ($kval)
        {
                ...
                <li <?php echo in_array($this->uri->segment(2), $set) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        ...
                        foreach ($acc as $cs)
                        {
                                if ($this->acl->is_allowed(array($cs), 1))
                                {
                                        $cval = TRUE;
                                        break;
                                }
                        ...
                        if ($cval)
                        {
                                ...
                                <li <?php echo in_array($this->uri->segment(2), $acc) ? 'class="active open inner-li"' : ''; ?>>
                                    ...
                                    <ul class="sub-menu">
                                        <?php
                                        if ($this->acl->is_allowed(array('offerings'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('tithes'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('thanks_giving'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('ministry_support'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('seed_planting'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('other_contributions'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('pledges'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('other_revenues'), 1))
                                        {
                                        ...
                                        <?php
                                        if ($this->acl->is_allowed(array('donations'), 1))
                                        {
                                                ?>
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('allocations'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('purchase_order'), 1))
                        {
        ...
        foreach ($pay as $ps)
        {
                if ($this->acl->is_allowed(array($ps), 1))
                {
                        $pval = TRUE;
                        break;
                }
        ...
        <?php $cset = array('sms', 'current', 'calendar', 'sms_counter', 'purchase_history', 'emails', 'sms_subscriptions', 'meetings', 'events', 'announcements'); ?>
        <?php
        $sval = false;
        foreach ($cset as $ss)
        {
                if ($this->acl->is_allowed(array($ss), 1))
                {
                        $sval = TRUE;
                        break;
                }
        ...
        {
                ?>
                <li <?php echo in_array($this->uri->segment(2), $cset) ? 'class="active open"' : ''; ?> <?php echo in_array($this->uri->segment(3), $cset) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('purchase_history'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('sms_subscriptions'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('meetings'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('announcements'), 1))
                        {
        ...
        <?php $aset = array('assets_trend', 'assets', 'asset_items', 'asset_stock', 'take_stock', 'asset_category'); ?>
        <?php
        $aval = false;
        foreach ($aset as $as)
        {
                if ($this->acl->is_allowed(array($as), 1))
                {
                        $aval = TRUE;
                        break;
                }
        ...
        {
                ?>
                <li <?php echo in_array($this->uri->segment(2), $aset) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        <?php
                        if ($this->acl->is_allowed(array('asset_category'), 1))
                        {
                                ?>
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('asset_items'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('asset_stock'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('take_stock'), 1))
                        {
        ...
        <?php
        if ($this->acl->is_allowed(array('folders'), 1))
        {
                ?>
        ...
        <?php
        if ($this->acl->is_allowed(array('church_projects'), 1))
        {
        ...
        <?php
        if ($this->acl->is_allowed(array('ministries'), 1))
        {
                ?>
        ...
        <?php
        if ($this->acl->is_allowed(array('hbcs'), 1))
        {
                ?><li <?php echo in_array($this->uri->segment(2), $set) ? 'class="active open"' : ''; ?>>
        ...
        <?php $rset = array('weddings', 'video_sermons', 'sermons', 'hymns_manager', 'bible_quotes', 'prayer_requests', 'daily_inspirations'); ?>
        <?php
        $fval = false;
        foreach ($rset as $rs)
        {
                if ($this->acl->is_allowed(array($rs), 1))
                {
                        $fval = TRUE;
                        break;
                }
        ...
        {
                ?>
                <li <?php echo in_array($this->uri->segment(2), $rset) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        <?php
                        if ($this->acl->is_allowed(array('weddings'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('sermons'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('video_sermons'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('hymns_manager'), 1))
                        {
                        ...
                        <?php } ?>
                        <?php
                        if ($this->acl->is_allowed(array('bible_quotes'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('prayer_requests'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('daily_inspirations'), 1))
                        {
        ...
        <?php $iset = array('reports', 'accounts_reports', 'accounts', 'members_reports', 'assets_reports', 'wages_reports', 'other_reports'); ?>
        <?php
        $rpv = false;
        foreach ($iset as $rq)
        {
                if ($this->acl->is_allowed(array($rq), 1))
                {
                        $rpv = TRUE;
                        break;
                }
        ...
        {
                ?>
                <li <?php echo in_array($this->uri->segment(2), $iset) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('reports', 'accounts_reports'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('reports', 'members_reports'), 1))
                        {
                                ?><li <?php echo in_array($this->uri->segment(3), $members) ? 'class="active open"' : ''; ?>>
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('reports', 'sms_reports'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('reports', 'assets_reports'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('reports', 'petty_cash'), 1))
                        {
                                ?><li <?php echo in_array($this->uri->segment(3), $set) ? 'class="active open"' : ''; ?>>
        ...
        <?php $cos = array('address_book', 'contacts', 'customers', 'suppliers', 'others'); ?>
        <?php
        $cv = false;
        foreach ($cos as $rv)
        {
                if ($this->acl->is_allowed(array($rv), 1))
                {
                        $cv = TRUE;
                        break;
                }
        ...
        {
                ?>
                <li <?php echo in_array($this->uri->segment(2), $cos) ? 'class="active open"' : ''; ?>>
                    ...
                    <ul class="sub-menu">
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('address_book', 'customers'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('address_book', 'suppliers'), 1))
                        {
                        ...
                        <?php
                        if ($this->acl->is_allowed(array('address_book', 'others'), 1))
                        {
